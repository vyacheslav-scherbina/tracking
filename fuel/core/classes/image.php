...
class Image
{
	 ...
	 * @return  Image_Driver
	 */
	public static function load($filename, $return_data = false)
	{
		return static::instance()->load($filename, $return_data = false);
	}
    
    public static function load_from_string($string)
	{
		return static::instance()->load_from_string($string);
	}
